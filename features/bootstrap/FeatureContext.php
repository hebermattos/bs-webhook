...
class FeatureContext implements Context, SnippetAcceptingContext
{
    ...
    public function iDoAPostAgainstHttpBswebhookComUmblerNetIndexPhpUrlBswebhook()   
    {
        try
        {
            $this->client->setDefaultOption('headers/X-Hub-Signature', 'sha1=745187d4669d44dba800abadb127c6ce777b8a0');
            
            $requestResponse = $this->client->request('POST', 'http://rc-bswebhook-com.umbler.net/index.php?_url=/bswebhook', [ 'body' => json_encode($this->validPayload) ]);
